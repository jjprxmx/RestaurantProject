...
public class Table{
    ...
    public static String[][] table01 = {{"NormalCourse :", "01", "02", "03", "04", "05", "06", "07", "08"}, {"VIP Course :", "01", "02", "03", "04"}};
    public static String[][] table02 = {{"NormalCourse :", "01", "02", "03", "04", "05", "06", "07", "08"}, {"VIP Course :", "01", "02", "03", "04"}};
    public static String[][] table03 = {{"NormalCourse :", "01", "02", "03", "04", "05", "06", "07", "08"}, {"VIP Course :", "01", "02", "03", "04"}};
    public static String[][] table04 = {{"NormalCourse :", "01", "02", "03", "04", "05", "06", "07", "08"}, {"VIP Course :", "01", "02", "03", "04"}};
    ...
    public static String[][]  reTable(int round){
        if(round==1) {
            return table01 = new String[][]{ {"NormalCourse :", "01", "02", "03", "04", "05", "06", "07", "08"}, {"VIP Course :", "01", "02", "03", "04"}};
        }
        else if(round==2) {
            return table02 = new String[][]{ {"NormalCourse :", "01", "02", "03", "04", "05", "06", "07", "08"}, {"VIP Course :", "01", "02", "03", "04"}};
        }
        else if(round==3) {
            return table03 = new String[][]{ {"NormalCourse :", "01", "02", "03", "04", "05", "06", "07", "08"}, {"VIP Course :", "01", "02", "03", "04"}};
        }
       else if(round==4) {
            return table04 = new String[][]{ {"NormalCourse :", "01", "02", "03", "04", "05", "06", "07", "08"}, {"VIP Course :", "01", "02", "03", "04"}};
        }
    ...
    public String toString(){
        return String.format("username: preemSoCute Course:%s , Round: %s , Table: %s ,Party Size: %d , Date: %d / %d / %d ",course,stRound,chooseTable,partySize,day,mount,year);
    }
